...
#numerical variables
   ...
   # rf_random.fit(X_train_R, y_train_R)
    ...
    st.write('**Social Support** and **Life Expectancy**: These features also show considerable dispersion, indicating a strong influence on the models predictions. Higher values (in red) tend to increase the model's outcome, while lower values (in blue) reduce it or have a neutral effect.')
